    ...
    <Container>
      <HeaderBox>
        <HeaderArea>
          ...
          <Menu>
            {isOpen?
              <Image src="/images/close.svg" alt="close" width="18px" height="18px" onClick={toggleMenu}/>
            : <Image src="/images/menu.svg" width="25px" height="18px" alt="menu" onClick={toggleMenu} />
            }
          </Menu>
